...
class Constant:
    LOGS_START_DATE: datetime = datetime(year=2024, month=4, day=7, hour=0, minute=0, second=0)
    LOGS_END_DATE: datetime = datetime(year=2025, month=1, day=1, hour=0, minute=0, second=0)
    NUMBER_LOGS: int = 50000
    ...
    HTTP_ERRORS_CODES: dict[str, list[str]] = {
    ...
    NUMBER_OF_ANOMALY_IPS: int = 9
    LOGS_DATASET_FILENAME: str = "data/logs_dataset.csv"
